<template>
  <div class="cube-index-list">
    ...
    <!--@touchmove.stop.prevent 改为@touchmove 为了使索引过长时能够滚动-->
    <div v-if="navbar" class="cube-index-list-nav" @touchstart="onShortcutTouchStart" @touchmove="onShortcutTouchMove">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      onPullingUp() {
          if(this.scrollOptions.onPullingUp) {
              this.scrollOptions.onPullingUp.call(this.$refs.indexList)
          }
      },  
      ...
      scroll(pos) {
        this.scrollY = pos.y
        var _itemEl = this.$el.getElementsByClassName('cube-index-list-nav-item active')[0]
        _itemEl.scrollIntoViewIfNeeded && _itemEl.scrollIntoViewIfNeeded()
      },
      titleClick() {
